...
$PDO = db_connect();
$sql = "INSERT INTO USUARIOS (CPF_USUARIO, NOME_USUARIO, EMPRESA_USUARIO, DEPARTAMENTO_USUARIO, CADASTRO_USUARIO)
        VALUES(:CPF_USUARIO, :NOME_USUARIO, :EMPRESA_USUARIO, :DEPARTAMENTO_USUARIO, CURRENT_TIMESTAMP)";
